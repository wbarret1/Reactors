...
namespace Reactors
{
    internal class MaterialCollectionConverter : System.ComponentModel.ExpandableObjectConverter
    {
        public override object ConvertTo(System.ComponentModel.ITypeDescriptorContext context,
                             System.Globalization.CultureInfo culture,
                             object value, Type destType)
        {
            if (destType == typeof(string) && value is MaterialCollection)
            {
                MaterialCollection matColl = (MaterialCollection)value;
                return matColl.Name;
            }
    ...
    [Serializable]
    [System.ComponentModel.TypeConverter(typeof(MaterialCollectionConverter))]
    public class MaterialCollection : System.Collections.Generic.List<Material>, System.ComponentModel.ICustomTypeDescriptor
    {
        ...
        public System.ComponentModel.PropertyDescriptorCollection GetProperties()
        {
            ...
            for (int i = 0; i < this.Count; i++)
            {
                ...
                MaterialCollectionPropertyDescriptor pd = new MaterialCollectionPropertyDescriptor(this, i);
                pds.Add(pd);
            }
            return pds;
        }
    ...
    public class MaterialCollectionPropertyDescriptor : System.ComponentModel.PropertyDescriptor
    {
        private MaterialCollection collection = null;
        private int index = -1;

        public MaterialCollectionPropertyDescriptor(MaterialCollection coll, int idx) : base("#" + idx.ToString(), null)
        {
        ...
        public override string DisplayName
        {
            get
            {
                Material comp = this.collection[index];
                return comp.Name;
            }
        }
